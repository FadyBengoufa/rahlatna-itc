...
.item, .item1, .item2 {
    position: absolute;
    bottom: -150px;  /* Moves them down */
    left: -250px;    /* Moves them more to the left */
    transform: rotate(-140deg) scale(4,1);
}
...
.item {
    width: 800px;
    height: 400px;
    background-color: #00274d73;
}

.item1 {
    width: 700px;
    height: 400px;
    background-color: #03417fa0;
}

.item2 {
    width: 600px;
    height: 400px;
    background-color: #00274d6b;
}
.fform {
    display: flex;
...
.form-row {
    display: flex;
    justify-content: center; /* Center within form */
    gap: 20px;
    width: 100%;
}
...
.fform {
    ...
    input {
        ...
        width: 200px;
        height: 30px;
        background-color:rgba(0, 30, 61, 0.19);
...
/* Apply small input styles only to Valid Through and CVV */
.small-input {
    width: 70px;
    height: 20px;
}
